        ...
        <div className="max-w-7xl mx-auto">
          {caseStudy.pdf_url ? (
            <div className="relative bg-white rounded-xl overflow-hidden shadow-2xl">
              ...
              <object
                data={caseStudy.pdf_url}
                type="application/pdf"
                className="w-full"
                style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}
                onLoad={() => setPdfLoading(false)}
              >
                {/* Fallback for browsers/environments that can't embed PDFs */}
                <div className="flex flex-col items-center justify-center p-12 bg-gray-50" style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}>
                  <svg className="w-16 h-16 text-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <p className="text-gray-600 mb-4 text-center" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  ...
                  <a
                    ...
                    className="px-6 py-3 bg-[#F96A63] text-white font-medium rounded-full hover:bg-[#e85a53] transition-colors"
                    style={{ fontFamily: 'Poppins, sans-serif' }}
                  >
                    Open PDF in New Tab
                  </a>
